  ...
  return (
    <div className="w-full md:w-1/2 p-6">
      ...
      <div className="space-y-2">
        {/* <p><span className="font-medium">Category:</span> {product.category}</p> {product.material} */}
        <p><span className="font-medium">Material: PLA</span> </p>
        {/* <p><span className="font-medium">Dimensions:</span> {product.dimensions}</p> {product.stock > 0 ? 'In Stock' : 'Out of Stock'}*/}
        <p><span className="font-medium">Availability: In Stock</span> </p>
      </div>
    </div>
  );
};
